...
set_project("TweakXL")
set_version("1.11.3", {build = "%y%m%d%H%M"})
...
add_requires("hopscotch-map", "inja", "minhook", "nlohmann_json", "spdlog", "tiltedcore", "yaml-cpp")
...
target("TweakXL")
    ...
    add_packages("hopscotch-map", "inja", "minhook", "nlohmann_json", "spdlog", "tiltedcore", "yaml-cpp")
