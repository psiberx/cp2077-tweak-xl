                                                                                        ...
                                                                                        RED4ext::TweakDBID aSampleId)
{
    ...
    const auto sampleId = aSampleId.IsValid() ? aSampleId : GetRecordSampleId(aType);

    assert(sampleId.IsValid());
...
RED4ext::TweakDBID TweakDB::Reflection::GetRecordSampleId(const RED4ext::CClass* aType)
{
    ...
    return reinterpret_cast<RED4ext::Handle<RED4ext::gamedataTweakDBRecord>*>(first)->GetPtr()->recordID;
}
